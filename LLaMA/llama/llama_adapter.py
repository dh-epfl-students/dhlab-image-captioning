...
class LLaMA_adapter(nn.Module):
    ...
    def __init__(self, llama_ckpt_dir, llama_tokenizer,
        ...
        # load llama configs
        print('Loading LLaMA configs', llama_ckpt_dir)
...
def load(name, llama_dir, llama_type="7B",
         device="cuda" if torch.cuda.is_available() else "cpu", download_root='ckpts', max_seq_len=512,
        phase="finetune"):
    if name in _MODELS:
