...
import torch
#config.init_device = 'meta' # For fast initialization directly on GPU!xin
import transformers

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
print('We found a device: ', device)
...
def create_model_and_transforms(
    ...
    **flamingo_kwargs,
    ...
    config = transformers.AutoConfig.from_pretrained(lang_encoder_path, trust_remote_code=True)
